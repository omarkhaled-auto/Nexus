...
function createMockRepoMap(): RepoMap {
  const files = [
    ...
    { relativePath: 'src/infrastructure/index.ts', absolutePath: '/test/project/src/infrastructure/index.ts', size: 200, lineCount: 20 },
    { relativePath: 'src/infrastructure/analysis/index.ts', absolutePath: '/test/project/src/infrastructure/analysis/index.ts', size: 300, lineCount: 30 },
    { relativePath: 'src/ui/index.ts', absolutePath: '/test/project/src/ui/index.ts', size: 150, lineCount: 15 },
    { relativePath: 'src/ui/components/Button.tsx', absolutePath: '/test/project/src/ui/components/Button.tsx', size: 400, lineCount: 40 },
    { relativePath: 'src/persistence/index.ts', absolutePath: '/test/project/src/persistence/index.ts', size: 200, lineCount: 20 },
    { relativePath: 'src/persistence/database.ts', absolutePath: '/test/project/src/persistence/database.ts', size: 500, lineCount: 50 },
  ];

  const symbols = [
    createSymbol('RepoMapGenerator', 'class', 'src/infrastructure/analysis/index.ts', true),
    createSymbol('generateRepoMap', 'function', 'src/infrastructure/analysis/index.ts', true),
    createSymbol('Button', 'function', 'src/ui/components/Button.tsx', true),
    createSymbol('useStore', 'function', 'src/ui/index.ts', true),
    createSymbol('Database', 'class', 'src/persistence/database.ts', true),
  ];

  const dependencies = [
    createDependency('src/ui/components/Button.tsx', 'react', 'import'),
    createDependency('src/ui/components/Button.tsx', 'zustand', 'import'),
    createDependency('src/persistence/database.ts', 'better-sqlite3', 'import'),
    createDependency('src/ui/index.ts', 'src/ui/components/Button.tsx', 'import'),
    createDependency('src/infrastructure/analysis/index.ts', 'src/infrastructure/index.ts', 'import'),
  ];
...
function createCircularRepoMap(): RepoMap {
  const files = [
    { relativePath: 'package.json', absolutePath: '/test/project/package.json', size: 100, lineCount: 10 },
    { relativePath: 'src/a.ts', absolutePath: '/test/project/src/a.ts', size: 100, lineCount: 10 },
    { relativePath: 'src/b.ts', absolutePath: '/test/project/src/b.ts', size: 100, lineCount: 10 },
    { relativePath: 'src/c.ts', absolutePath: '/test/project/src/c.ts', size: 100, lineCount: 10 },
  ];

  // Create circular: a -> b -> c -> a
  const dependencies = [
    createDependency('src/a.ts', 'src/b.ts', 'import'),
    createDependency('src/b.ts', 'src/c.ts', 'import'),
    createDependency('src/c.ts', 'src/a.ts', 'import'),
  ];
