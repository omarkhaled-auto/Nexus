...
const DEFAULT_RESPONSE = 'This is a mock response from Gemini.';
...
/**
 * Mock Gemini client for testing LLM interactions
...
export class MockGeminiClient implements LLMClient {
  ...
  constructor(config: MockResponseConfig = {}) {
    this.config = {
      ...
      errorMessage: config.errorMessage ?? 'Mock Gemini error',
    };
