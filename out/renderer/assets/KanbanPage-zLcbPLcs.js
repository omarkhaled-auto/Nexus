import { c as createLucideIcon, r as reactExports, E, b as reactDomExports, j as jsxRuntimeExports, a as cn, u as useComposedRefs, d as createContextScope, P as Primitive, e as Presence, f as composeEventHandlers, g as useCallbackRef, h as useLayoutEffect2, X, i as useTaskStore, D as Dialog, k as DialogContent, l as DialogHeader, m as DialogTitle, n as DialogDescription, B as Button } from "./index-O-vtW4Ab.js";
import { B as Bot, u as useFeatureStore, a as useFeatureCount } from "./featureStore-C7tHQ3u3.js";
...
function ProgressIndicator({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-center gap-2", className), children: [
    ...
    showLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-[2.5rem] text-right text-xs text-muted-foreground", children: [
      clampedProgress,
      "%"
    ] })
  ] });
...
function AgentStatusIndicator({ agentId, status }) {
  if (!agentId) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground/50", children: [
  ...
  const displayName = formatAgentName$1(agentId);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: cn("h-3.5 w-3.5", isActive && "text-emerald-500") }),
      isActive && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -right-0.5 -top-0.5 h-2 w-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-medium", isActive && "text-foreground"), children: displayName }),
    status && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(isActive && "text-emerald-600"), children: status })
    ] })
  ] });
}
function formatAgentName$1(agentId) {
  const agentTypes = {
    coder: "Coder",
    qa: "QA",
    reviewer: "Reviewer",
  ...
  for (const [key2, display] of Object.entries(agentTypes)) {
    if (lowerAgentId.includes(key2)) {
      return display;
    }
  }
...
function FeatureCard({ feature, isOverlay = false, onClick }) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: cn(
        ...
        PRIORITY_COLORS$1[feature.priority],
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "flex-1 font-medium text-foreground", children: feature.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ComplexityBadge, { complexity: feature.complexity })
        ] }),
        feature.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 line-clamp-2 text-sm text-muted-foreground", children: feature.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 border-t border-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressIndicator, { progress: feature.progress, showLabel: true, className: "mb-2" }),
        feature.qaIterations !== void 0 && feature.qaIterations > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-2 text-xs text-muted-foreground", children: [
          "QA: ",
          feature.qaIterations,
          "/50"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AgentStatusIndicator,
          {
            ...
            status: getAgentStatus$1(feature)
          }
        )
      ]
    }
...
function getAgentStatus$1(feature) {
...
function KanbanColumn({ column, features, onFeatureClick }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground", children: column.title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: featureIds, strategy: verticalListSortingStrategy, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 flex-col space-y-2 overflow-y-auto", children: features.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          FeatureCard,
          {
            feature,
            onClick: onFeatureClick ? () => onFeatureClick(feature) : void 0
          },
          feature.id
        )) }) })
      ]
...
function StatusIndicator({ status }) {
  switch (status) {
    case "completed":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3 w-3 text-emerald-500" }) });
    case "failed":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-red-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3 w-3 text-red-500" }) });
    case "in_progress":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-5 w-5 shrink-0 items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "h-3 w-3 fill-amber-500 text-amber-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-ping rounded-full bg-amber-500/30" })
      ] });
    case "pending":
    default:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "h-3 w-3 text-muted-foreground" }) });
  }
}
function formatAgentName(agentId) {
  return agentId.replace(/-agent$/, "").replace(/^agent-/, "").replace(/^\w/, (c) => c.toUpperCase());
}
...
function TaskList({ tasks, featureId: _featureId }) {
  if (tasks.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4 text-center text-sm text-muted-foreground", children: "No tasks yet" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: tasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: cn(
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatusIndicator, { status: task.status }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
        ...
        task.assignedAgent && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 rounded bg-muted px-1.5 py-0.5 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "h-3 w-3" }),
          formatAgentName(task.assignedAgent)
        ] }),
        task.estimatedMinutes !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatTime$1(task.estimatedMinutes) })
      ]
    },
    task.id
  )) });
...
function getAgentStatus(feature) {
  switch (feature.status) {
    case "planning":
      return "Decomposing tasks";
    case "in_progress":
...
function getFeatureTasks(feature, allTasks) {
  if (feature.tasks.length > 0) {
    const realTasks = feature.tasks.map((taskId) => allTasks.find((t) => t.id === taskId)).filter((t) => t !== void 0);
...
function generateDemoTasks(feature) {
  const taskTemplates = [
...
function generateActivityTimeline(feature) {
  const activities = [];
  const baseTime = new Date(feature.updatedAt);
  if (feature.status !== "backlog") {
    activities.push({
      time: formatTime(new Date(baseTime.getTime() - 30 * 6e4)),
      event: "Feature moved to planning"
    });
  }
  if (["in_progress", "ai_review", "human_review", "done"].includes(feature.status)) {
    activities.push({
      time: formatTime(new Date(baseTime.getTime() - 20 * 6e4)),
      event: "Agent started working"
    });
    activities.push({
      time: formatTime(new Date(baseTime.getTime() - 15 * 6e4)),
      event: "Build passed"
    });
  }
  if (["ai_review", "human_review", "done"].includes(feature.status)) {
    activities.push({
      time: formatTime(new Date(baseTime.getTime() - 10 * 6e4)),
      event: "Code submitted for review"
    });
  }
  if (feature.status === "done") {
    activities.push({
      time: formatTime(new Date(baseTime.getTime() - 5 * 6e4)),
...
function FeatureDetailModal({ feature, open, onOpenChange }) {
  const allTasks = useTaskStore((s) => s.tasks);
  if (!feature) return null;
  const tasks = getFeatureTasks(feature, allTasks);
  const activities = generateActivityTimeline(feature);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-h-[85vh] max-w-2xl overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 pr-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl", children: feature.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ComplexityBadge, { complexity: feature.complexity })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-left", children: feature.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[calc(85vh-140px)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pr-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 border-t border-border pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: formatStatus(feature.status)
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm capitalize", children: feature.priority })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressIndicator, { progress: feature.progress, showLabel: true, className: "h-3" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        AgentStatusIndicator,
        {
          agentId: feature.assignedAgent,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "mb-3 text-sm font-medium text-foreground", children: [
          "Tasks (",
          tasks.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TaskList, { tasks, featureId: feature.id })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-3 text-sm font-medium text-foreground", children: "Activity Timeline" }),
        activities.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: activities.map((activity, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-12 shrink-0 text-muted-foreground", children: activity.time }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-1.5 shrink-0 rounded-full bg-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: activity.event })
        ] }, idx)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No activity yet" })
      ] })
    ] }) })
  ] }) });
}
...
function KanbanBoard() {
  ...
  function handleDragEnd(event) {
    ...
    const overColumnId = over.data.current?.columnId || over.data.current?.sortable?.containerId || over.id;
...
function KanbanHeader({ projectName, onNewFeature }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between border-b border-border bg-background px-6 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-5 w-5 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-foreground", children: projectName || "Evolution Mode" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-full bg-muted px-2.5 py-0.5 text-sm font-medium text-muted-foreground", children: [
        featureCount,
        " ",
