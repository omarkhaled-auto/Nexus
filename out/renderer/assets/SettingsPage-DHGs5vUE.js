...
import { H as Header } from "./Header--HwKPh06.js";
import { R as RotateCcw } from "./rotate-ccw-BZkFTlrD.js";
import { S as Save, C as Cpu } from "./save-6EtD5rSs.js";
import { I as Info } from "./info-XadYYNMs.js";
import "./arrow-left-yxdXLnsb.js";
/**
...
function CheckpointList({ projectId }) {
  const {
    checkpoints,
    isLoading,
    loadCheckpoints,
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-muted-foreground", children: "Loading checkpoints..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Checkpoints" }),
    ...
    checkpoints.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No checkpoints yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: checkpoints.map((cp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        className: "flex items-center justify-between p-3 border rounded-lg",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: cp.name || cp.reason || "Unnamed checkpoint" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: formatDistanceToNow(new Date(cp.createdAt), { addSuffix: true }) })
          ] }),
...
function CheckpointSettings({ settings, updateSetting }) {
  ...
  const [loadingProjects, setLoadingProjects] = reactExports.useState(true);
  const loadProjects = reactExports.useCallback(async () => {
    ...
    try {
      const projectList = await window.nexusAPI.getProjects();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-testid": "checkpoints-tab", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-bg-card border-border-default", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-bg-card border-border-default", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Project Checkpoints" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "View, restore, and manage checkpoints for your projects." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: loadingProjects ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-text-secondary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-4 border-2 border-accent-primary border-t-transparent rounded-full animate-spin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Loading projects..." })
      ] }) : projects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-secondary", children: "No projects found. Create a project to manage checkpoints." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Select,
          {
        ...
        selectedProjectId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border-default", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckpointList, { projectId: selectedProjectId }) })
      ] }) })
    ] })
  ] });
}
