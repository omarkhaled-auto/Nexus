...
function PlanningSteps({ currentStatus }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-2 sm:gap-4", "data-testid": "planning-steps", children: steps.map((step, index) => {
...
function ErrorState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-6 p-8", "data-testid": "error-state", children: [
...
function CompleteState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-6 p-8 animate-in fade-in duration-500", "data-testid": "complete-state", children: [
...
function PlanningPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedPage, { className: "min-h-full bg-bg-dark", "data-testid": "planning-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-12", children: [
    ...
    isLoading && !isError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bg-card rounded-xl border border-border-default p-6", "data-testid": "progress-stats", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-5 h-5 text-accent-primary animate-spin" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary font-medium", "data-testid": "current-step", children: currentStep })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { progress, className: "mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-text-secondary", "data-testid": "progress-percent", children: [
            Math.round(progress),
            "% complete"
          ] }),
      ...
      tasksCreated.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bg-card rounded-xl border border-border-default p-6", "data-testid": "task-list", children: [
    ...
    status === "idle" && (!locationState?.requirements || locationState.requirements.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", "data-testid": "idle-state", children: [
