import { c as createLucideIcon, r as reactExports, R as React, k as reactDomExports, j as jsxRuntimeExports, l as Card, a as cn, m as CardHeader, n as CardTitle, o as CardContent, p as useFeatureStore, D as Dialog, q as DialogContent, s as DialogHeader, T as TriangleAlert, v as DialogTitle, w as DialogDescription, x as DialogFooter, y as Button, L as LoaderCircle, z as useFeatureCount, P as Plus } from "./index-C-P9gv8r.js";
import { C as Circle, A as AnimatedPage } from "./AnimatedPage-kxF8xqL7.js";
import { C as Clock } from "./clock-Cfj-dkBa.js";
import { T as Trash2 } from "./trash-2-DkjKaby1.js";
import { C as CircleX } from "./circle-x-DmGWgNdE.js";
import { C as CircleCheck } from "./circle-check-D8bQKBkt.js";
import { L as Layers } from "./layers-BC576AtS.js";
import { S as Search, I as Input } from "./Input-D8Acil3U.js";
import "./circle-alert-Bq2SZuv_.js";
import "./eye-off-CPyjqvte.js";
import "./eye-DcIDhFBq.js";
/**
  ...
  ({ feature, onClick, isDragging, isOverlay, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-3 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "line-clamp-2 text-sm font-medium", children: feature.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                ...attributes,
                ...listeners,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-4 w-4 text-muted-foreground" })
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-3 line-clamp-2 text-xs text-muted-foreground", children: feature.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: cn("h-2 w-2 fill-current", priorityColors$1[feature.priority]) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded bg-muted px-1.5 py-0.5 text-xs", children: complexityLabels[feature.complexity] })
              ] }),
              totalTasks > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                completedTasks,
                "/",
                totalTasks,
                " tasks"
            ...
            feature.assignedAgent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-1 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: feature.assignedAgent })
            ] })
          ] })
        ]
      }
...
function FeatureDetailModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: feature.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium capitalize", children: feature.status.replace("_", " ") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Complexity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium capitalize", children: feature.complexity })
        ] }),
        feature.assignedAgent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Assigned Agent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: feature.assignedAgent })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Created" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: new Date(feature.createdAt).toLocaleDateString() })
        ] })
      ] }),
